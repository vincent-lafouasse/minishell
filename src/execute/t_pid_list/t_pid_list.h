...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/30 20:32:20 by poss              #+#    #+#             */
/*   Updated: 2025/01/30 20:32:50 by poss             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		pidl_push_back_link(t_pid_list **pidl,
				t_pid_list *link);
void		pidl_push_front_link(t_pid_list **pidl,
				t_pid_list *link);
